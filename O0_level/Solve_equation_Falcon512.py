...
def select_known_positions(
    ...
    """
Select at most `max_known` known items from the candidate set dictionary, prioritizing values of 0 and ±1, followed by ±2 and ±3, then ±4 and ±5.
...
def run_experiments(f_dir: str, g_dir: str, h_csv_path: str, out_csv_path: str, num: int = 100):
    ...
    for i in range(num):
        ...
        f_vec, msg_f = select_known_positions(f_dict, max_known=256, n=512)
        g_vec, msg_g = select_known_positions(g_dict, max_known=256, n=512)
